...
local function drawEndGameScreen(win)
...
function love.load()
    ...
    selectionButtons = {
        ...
        { time = .2, text = "End Window tryout", x = startX, y = startY + (buttonH + buttonSpacing) * 2, w = buttonW, h = buttonH },
    }
...
local function drawWindow(win)
    ...
    drawEndGameScreen(win) -- Call the new function
    end
